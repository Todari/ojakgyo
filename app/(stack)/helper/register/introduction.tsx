  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        <Typography variant='title' weight='bold' style={styles.title}>자기소개를 작성해주세요</Typography>
        <Typography variant='body' style={styles.subtitle}>어르신들이 안심하고 도움을 요청할 수 있도록{"\n"}자세히 작성해주세요</Typography>
